...
const ROW_COL_DIACRITICS = [
	...
	0x0352, 0x0353, 0x0357, 0x035b, 0x0363, 0x0364, 0x0365, 0x0366, 0x0367, 0x0368, 0x0369, 0x036a, 0x036b, 0x036c,
	0x036d, 0x036e, 0x036f, 0x0483, 0x0484, 0x0485, 0x0486, 0x0592, 0x0593, 0x0594, 0x0595, 0x0597, 0x0598, 0x0599,
	0x059c, 0x059d, 0x059e, 0x059f, 0x05a0, 0x05a1, 0x05a8, 0x05a9, 0x05ab, 0x05ac, 0x05af, 0x05c4, 0x0610, 0x0611,
	0x0612, 0x0613, 0x0614, 0x0615, 0x0616, 0x0617, 0x0618, 0x0619, 0x061a, 0x064b, 0x064c, 0x064d, 0x064e, 0x064f,
	0x0650, 0x0651, 0x0652, 0x0653, 0x0654, 0x0655, 0x0656, 0x0657, 0x0658, 0x0659, 0x065a, 0x065b, 0x065c, 0x065d,
	0x065e, 0x065f, 0x0670, 0x06d6, 0x06d7, 0x06d8, 0x06d9, 0x06da, 0x06db, 0x06dc, 0x06df, 0x06e0, 0x06e1, 0x06e2,
	0x06e3, 0x06e4, 0x06e7, 0x06e8, 0x06ea, 0x06eb, 0x06ec, 0x06ed,
];
const PLACEHOLDER_CHAR = String.fromCodePoint(0x10eeee);
const ESC = "\u001b";
const KITTY_GRAPHICS_PATTERN = new RegExp(`${ESC}_G([^${ESC}]*)${ESC}\\\\`, "g");
...
function wrapForTmux(sequence: string): string {
	...
	return sequence.replace(
		KITTY_GRAPHICS_PATTERN,
		(_match, content) => `${ESC}Ptmux;${ESC}${ESC}_G${content}${ESC}${ESC}\\${ESC}\\`,
	);
}
